...
// Requirement 1: Lookup Tables using Constant Arrays
...
// 2D Bed Occupancy Tracking Matrix
...
typedef struct {
    ...
    char name[100];
    int age;
    int urgency_level;      // 1 = Normal, 2 = Urgent, 3 = Critical
    int specialty_id;
    int is_admitted;
    int ward_id;
    int days_admitted;
...
void registerPatient()
{
    ...
    // Requirement 3.1: Estimated Waiting Time
    p.wait_time =
    ...
    // Requirement 3.2: Emergency Surcharge
